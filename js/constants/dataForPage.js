...
const text = `Таким образом новая модель организационной деятельности представляет собой интересный эксперимент проверки модели развития. Разнообразный и богатый опыт рамки и место обучения кадров влечет за собой процесс внедрения и модернизации существенных финансовых и административных условий.
...
const tourText = `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus posuere efficitur purus nec facilisis.
...
module.exports = [
  { section: 'news', date: 1464626230695, header: 'Самая последняя новость', text },
  { section: 'news', date: 1463762230000, header: 'Какая-то майская новость', text },
  { section: 'news', date: 1462898229305, header: 'Первая новость в мае', text },
  { section: 'news', date: 1431362229305, header: 'Новость из 2015 года', text },
